...
const DigestiveSystem = ({ videoSrc, videoRef }) => {
  useEffect(() => {
...
const App = () => {
  ...
  const videoSrc = "/ds.mp4"; // 🔹 Ensure this file is inside `public/videos/`

  return (
    <div style={{ width: "100vw", height: "100vh" }}>
      <video ref={videoRef} style={{ display: "none" }} />
      <DigestiveSystem videoSrc={videoSrc} videoRef={videoRef} />
